...
/**
 * <p>
 * <code>Tag</code> defines behaviour for a MARC tag.
 * </p>
 *
 * <p>
 * A MARC tag is a three character string used to identify an
...
public class Tag
{
     ...
     *
     * <p>
     * The method returns true if the tag contains three alphabetic
     * or numeric ASCII graphic characters.
     * </p>
     *
     * <p>
     * <b>Note:</b> mixing uppercase and lowercase letters is not
     * validated.
     * </p>
     *
     ...
     *
     * <p>
     * The method returns false if the tag does not begin with
     * two zero's.
     * </p>
     *
     * @param tag the tag name
