...
public class CodeTableTracker
{
     ...
     * return "G0: [" + Integer.toHexString(g[G0][prev]) + ", " + Integer.toHexString(g[G0][curr]) + ", "+
     * Integer.toHexString(g[G0][next]) + "]\n" +
     * "G1: ["+ Integer.toHexString(g[G1][prev]) + ", " + Integer.toHexString(g[G1][curr]) + ", "+
     * Integer.toHexString(g[G1][next]) + "]\n";
     * }
     */
}
